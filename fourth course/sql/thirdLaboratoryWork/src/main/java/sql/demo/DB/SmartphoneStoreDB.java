...
public class SmartphoneStoreDB {
    public static final String DB_URL = "jdbc:h2:g:/Java/thirdLaboratoryWork/db/smartphoneStore";    //для создания бд при первом подключении
    public static final String DB_Driver = "org.h2.Driver";

    private static SessionFactory sessionFactory = null;        //добавляем
    static {
        try {
